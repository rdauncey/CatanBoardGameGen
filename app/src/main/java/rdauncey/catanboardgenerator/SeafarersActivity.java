...
public class SeafarersActivity extends AppCompatActivity {

    public static BoardType board = new BoardType("seafarers");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seafarers);
