...
public class SeafarersNewActivity extends AppCompatActivity {

    public static BoardType board = new BoardType("s-new");
    ...
    private BlockType sea = new BlockType("sea", "#000000", board.blockCounts.get("sea"), 'o');
    private BlockType[] blockTypes = {brick, stone, wood, wheat, sheep, sea};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seafarers_new);
    ...
    public void drawHex(int position, Character t, int number) {
        ...
        switch (t) {
            ...
            case 'h':   imageView.setBackground(getResources().getDrawable(R.drawable.wheat_hex));
                break;
            case 'o':   imageView.setBackground(getResources().getDrawable(R.drawable.blue_hex));
                break;
        }
    ...
    public void generateBoard(View view) {
        ...
        for (int j = 1; j <= blockCount; j++) {
            ...
            if (block.name.contentEquals("sea")) {
