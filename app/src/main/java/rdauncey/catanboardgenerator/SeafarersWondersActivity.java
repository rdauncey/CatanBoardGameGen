...
public class SeafarersWondersActivity extends AppCompatActivity {

    public static BoardType board = new BoardType("s-wonders");
    ...
    private BlockType gold = new BlockType("gold", "#ffd454", board.blockCounts.get("gold"), 'g');
    private BlockType[] blockTypes = {brick, stone, wood, wheat, sheep, gold};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seafarers_wonders);
    ...
    public void generateBoard(View view) {
        ...
        for (int j = 1; j <= blockCount; j++) {
            ...
            //Blocks next to desert can't have 6 or 8
            if (j == 17 || j == 19) {
