...
public class SeafarersClothActivity extends AppCompatActivity {

    public static BoardType board = new BoardType("s-cloth");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seafarers_cloth);
