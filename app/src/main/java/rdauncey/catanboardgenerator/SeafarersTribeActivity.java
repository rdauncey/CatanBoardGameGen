...
public class SeafarersTribeActivity extends AppCompatActivity {

    public static BoardType board = new BoardType("s-tribe");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seafarers_tribe);
    ...
    public void generateBoard(View view) {
        ...
        for (int j = 1; j <= blockCount; j++) {
            ...
            //Make sure the bottom of the island doesn't have high numbers
            if (j < 3) {
