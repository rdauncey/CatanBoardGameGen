...
public class SeafarersFourActivity extends AppCompatActivity {

    public static BoardType board = new BoardType("s-four");
    ...
    private BlockType[] blockTypes = {brick, stone, wood, wheat, sheep, desert};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seafarers_four);
